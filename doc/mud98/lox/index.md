...
- **Tooling/AI agents** that need a consistent, machine-readable reference.

No prior knowledge of ["vanilla" Lox](https://craftinginterpreters.com/) is required; this documentation describes the language exactly as it exists inside Mud98.
