...
typedef struct obj_prototype_t {
    ...
    union {
        ...
        struct { int gather_type; int mat_vnum; int quantity; int min_skill; int unused4; } gather;
        ...
        struct { int station_flags; int bonus; int min_skill; int unused3; int unused4; } workstation;
    };
